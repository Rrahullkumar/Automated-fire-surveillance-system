...
print(os.path.exists("C:/Users/HP/Python/Fire_detection_system/fire.xml"))

cascade_file_path = os.path.abspath("C:/Users/HP/Python/Fire_detection_system/fire.xml")
fire_cascade = cv2.CascadeClassifier(cascade_file_path)
...
def play_alarm_sound_function(): # defined function to play alarm post fire detection using threading
    playsound.playsound("C:/Users/HP/Python/Fire_detection_system/Alarm Sound.mp3",True) # to play alarm # mp3 audio file is also provided with the code.
...
def send_mail_function(): # defined function to send mail post fire detection using threading
    ...
    recipientmail = "31hope.02@gmail.com" # recipients mail
    ...
    try:
        ...
        server.ehlo()
        server.starttls()
        server.login("31hope.02@gmail.com", 'Vinod.2002') # Senders mail ID and password
        server.sendmail('sahil02official@gmail.com', recipientmail, "Warning fire accident has been reported") # recipients mail with mail message
